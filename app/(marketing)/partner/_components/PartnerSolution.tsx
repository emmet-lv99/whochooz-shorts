...
export default function PartnerSolution() {
  return (
    <section className="min-h-screen flex flex-col md:flex-row items-center justify-center px-6 py-24 relative overflow-hidden">
      ...
      {/* Content Side */}
      <div className="md:w-1/2 max-w-xl z-10 mb-16 md:mb-0">
        <motion.h2 
      ...
      <motion.div 
        ...
        className="md:w-1/2 flex justify-center z-10 perspective-1000"
      >
        <div className="w-[300px] h-[600px] border-4 border-white/20 rounded-[3rem] bg-gradient-to-br from-white/10 to-transparent backdrop-blur-xl shadow-2xl relative overflow-hidden transform rotate-y-12 hover:rotate-y-0 transition-transform duration-500">
           {/* Phone Notch */}
           <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-black rounded-b-xl z-20" />
           
           {/* Screen UI Mockup */}
           <div className="w-full h-full p-6 flex flex-col pt-16 space-y-4">
