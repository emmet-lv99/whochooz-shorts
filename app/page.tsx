...
export default async function Home() {
  // 1. 서비스 데이터 호출 (1페이지 10개)
  // 메인에서는 딱 10개만 보여주고 끝.
  const campaigns = await campaignService.getAllList('open', 1, 10);
  ...
  return (
    <main className="pb-24">
      ...
      <section className="px-4 py-6">
        ...
        {/* 3. 정적 캠페인 리스트 (2열 그리드) - InfiniteScroll 아님 */}
